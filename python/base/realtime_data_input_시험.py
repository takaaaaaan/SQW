...
# 移動距離の範囲を定義
# def select_ship_and_speed(SHIP_SPEEDS, SHIP_PROBABILITIES, SPEED_VARIATION=0.2, TIME_INTERVAL=1):
...
#     min_speed = AVERAGE_SPEED * (1 - SPEED_VARIATION)
#     max_speed = AVERAGE_SPEED * (1 + SPEED_VARIATION)
#     DISTANCE_CHANGE_RANGE = (min_speed * TIME_INTERVAL, max_speed * TIME_INTERVAL)

#     return ship_type, AVERAGE_SPEED, DISTANCE_CHANGE_RANGE
